...
@Component({
  selector: 'app-coonoor',
  templateUrl: './coonoor.component.html',
  styleUrls: ['./coonoor.component.css'],
})
export class CoonoorComponent implements OnInit {
  
  ngOnInit(): void {
    this.places = this._placesService.CoonoorPlace();
  }
