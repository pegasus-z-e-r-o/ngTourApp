...
@Component({
  selector: 'app-thiruvannamalai',
  templateUrl: './thiruvannamalai.component.html',
  styleUrls: ['./thiruvannamalai.component.css'],
})
export class ThiruvannamalaiComponent implements OnInit {
  ngOnInit(): void {
    this.places = this.placesService.ThiruvannamalaiPlace();
  }
